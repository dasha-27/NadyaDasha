...
class Form(QWidget):
    ...
    def setPatch(self):
        self.OpenFile = QFileDialog.getOpenFileNames(self, "D:\\", "D:\\", "'(*.png)'")[0][0]
        self.loadImage()

    def loadImage(self):
        self.path = QPainterPath()
        self.image.load(str(self.OpenFile), "*.png")
        self.update()
...
if __name__ == '__main__':
    ...
    drawer = Form()
    BtnSave.clicked.connect(lambda: drawer.image.save(drawer.OpenFile, "PNG"))
